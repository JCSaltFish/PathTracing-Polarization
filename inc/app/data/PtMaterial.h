...
private:
    ...
    float m_intensity = 0.0f; // Intensity of the material
    ...
    DbFilePath m_intensityTexPath; // Path to intensity texture
...
public:
    ...
    /**
     * @brief Get the intensity of the material.
     * @param hMaterial Handle to the material object.
     * @return Intensity value, or 0.0f if invalid.
     */
    static float getIntensity(const DbObjHandle& hMaterial);
    /**
     * @brief Set the intensity of the material.
     * @param hMaterial Handle to the material object.
     * @param intensity New intensity value.
     * @return Result code indicating success or failure.
     */
    static DB::Result setIntensity(const DbObjHandle& hMaterial, float intensity);
    /**
    ...
    /**
     * @brief Get the file path of the intensity map texture.
     * @param hMaterial Handle to the material object.
     * @return File path as a string, or empty string if invalid.
     */
    static std::string getIntensityTexPath(const DbObjHandle& hMaterial);
    /**
     * @brief Set the file path of the intensity map texture.
     * @param hMaterial Handle to the material object.
     * @param path New file path as a string.
     * @return Result code indicating success or failure.
     */
    static DB::Result setIntensityTexPath(const DbObjHandle& hMaterial, const std::string& path);
    /**
